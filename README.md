...
Currently Axon is 2X faster than Express. :D please checkout [Axon Benchmarks](_media/README.md)
...
[Axon Benchmarks](_media/README.md)
...
- [Typescript Example](_media/index.ts)
- [Javascript Example](_media/index.js)
